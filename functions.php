...
if( ! class_exists( 'Codexin_Framework' ) ) {
	...
	class Codexin_Framework {
		...
		public function codexin_includes() {
			 ...
			 *
			 */
			require trailingslashit( get_template_directory() ) . 'inc/admin/admin-options.php';
			...
			/**
			 * Include some debloating for faster speed
			 *
			 */
			require_once trailingslashit( get_template_directory() ) . 'inc/admin/wp-debloat.php';

			/**
			 * Adding the function to pass colors from theme options
			 *
			 */
			require_once trailingslashit( get_template_directory() ) . 'inc/frontend/color-patterns.php';
		...
		*/
		...
		public function codexin_setup_core() {
			...
			$theme_args = array(
			    ...
			    'flex-height'   => true,
			    'height'        => 200,
			    'default-image' => trailingslashit( get_template_directory_uri() ) . 'assets/images/default-header.jpg',
			);
		...
		public function codexin_admin_styles() {
			wp_enqueue_style( 'codexin-theme-options-stylesheet', trailingslashit( get_template_directory_uri() ) . 'assets/css/admin/admin-styles.css', false, '1.0','all');
		}
