...
module.exports = {
	...
	// Project options.
	projectName: 'codexin',
	projectURL: 'localhost/codexin', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	// Translation options.
	textDomain: 'TEXT_DOMAIN', // Your textdomain here.
	translationFile: 'TEXT_DOMAIN.pot', // Name of the translation file.
	translationDestination: './languages', // Where to save the translation files.
	packageName: 'Codexin Framework', // Package name.
